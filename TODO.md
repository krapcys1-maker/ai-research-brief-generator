...
- [x] Expand source-quality fixtures with more recorded live-source failures.
...
- [x] Add a CI quality gate for retrieval/source-quality/claim-check benchmark thresholds.
