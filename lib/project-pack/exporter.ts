  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "            if score_gap < 0.05:",
        "                reasons = [f\"near-tie with top candidate by rank-adjusted score ({item_display_score:.1f} vs {top_display_score:.1f}); top rank kept by deterministic ordering and stronger repair target shape\"]",
        "            else:",
