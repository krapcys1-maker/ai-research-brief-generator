  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "            score_gap = top['score'] - item['score']",
        "            if score_gap < 0.05:",
        "                reasons = [f\"near-tie with top candidate ({item['score']:.1f} vs {top['score']:.1f}); top rank kept by deterministic ordering and stronger repair target shape\"]",
        "            else:",
        "                reasons = [f\"lower score than top candidate ({item['score']:.1f} vs {top['score']:.1f})\"]",
