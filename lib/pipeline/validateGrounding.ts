...
const TOKEN_TRANSLATIONS: Record<string, string[]> = {
  ...
  centralizacji: ["centralization"],
  dane: ["data"],
  danych: ["data"],
  diagnoza: ["diagnosis"],
  diagnostyka: ["diagnosis"],
  diagnostyczn: ["diagnosis"],
  dezinformacja: ["disinformation", "misinformation"],
  dezinformacji: ["disinformation", "misinformation"],
  dezinformacyjne: ["disinformation", "misinformation"],
  dezinformacyjnych: ["disinformation", "misinformation"],
  finansow: ["financial"],
  finansowe: ["financial"],
  finansowych: ["financial"],
  federacyjne: ["federated"],
  federacyjnego: ["federated"],
  federacyjnych: ["federated"],
  graf: ["graph"],
  grafowe: ["graph"],
  grafowego: ["graph"],
  grafowych: ["graph"],
  ...
  kontrastowego: ["contrastive"],
  koordynowane: ["coordinated"],
  koordynowanych: ["coordinated"],
  koordynowany: ["coordinated"],
  media: ["media"],
  mediow: ["media"],
  medyczn: ["medical"],
  model: ["model"],
  ...
  redukcja: ["reduce"],
  redukuje: ["reduce"],
  roznicowa: ["differential"],
  roznicowej: ["differential"],
  spolecznosciowe: ["social"],
  spolecznosciowych: ["social"],
  siec: ["network"],
  sieci: ["networks"],
  ...
  wykryc: ["detect", "detection"],
  wykrywa: ["detect", "detection"],
  wykrywac: ["detect", "detection"],
  wykrywanie: ["detect", "detection"],
  wyszukiwa: ["retrieve"],
